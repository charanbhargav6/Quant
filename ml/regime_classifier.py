...
class RegimeClassifier:
    ...
    def detect_regime_rules(self, df: pd.DataFrame,
        ...
        try:
            ...
            # Trend detection — EMA200 included to match _label_regime() conditions
            e200_ok     = not pd.isna(e200)
            bullish_ema = last > e21 > e50 and (not e200_ok or e50 > e200)
            bearish_ema = last < e21 < e50 and (not e200_ok or e50 < e200)
